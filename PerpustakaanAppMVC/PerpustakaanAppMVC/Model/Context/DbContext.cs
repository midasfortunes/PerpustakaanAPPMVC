    ...
    public class DbContext : IDisposable
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"D:\Kuliah\Semester 3\Pemograman Lanjut\pertemuan10_11\Operasi CRUD MVC Part #2\Operasi CRUD MVC Part #2\PerpustakaanAppMVC\Database\DbPerpustakaan.db";
